...
uint32_t nWifi = 20, nFlow = 10, nPkt = 100, payloadSize = 1024, coverageFactor = 1, mSpeed=5;
...
printPlotData()
{
    ...
    else if (plotParam == "speed") param = mSpeed;
    else return;
    NS_LOG_UNCOND(plotParam);
    std::ostringstream thpPath, pdrPath;
    thpPath << "scratch/plots/2/throughput_v_" << plotParam << ".dat";
    pdrPath << "scratch/plots/2/pdr_v_" << plotParam << ".dat";
...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("speed", "Node movement speed", mSpeed);
    ...
    mobility.SetMobilityModel("ns3::RandomWalk2dMobilityModel", 
                              ...
                              "Speed",  StringValue("ns3::ConstantRandomVariable[Constant=" + std::to_string(mSpeed) + "]"));
    ...
    //     pointToPoint.EnablePcapAll("f2-mobile");
    //     phy1.EnablePcap("f2-mobile", apDevices1.Get(0));
    // }
